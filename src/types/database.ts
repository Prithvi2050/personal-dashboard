...
export type Database = {
  public: {
    Tables: {
      ...
      user_settings: {
        Row: { user_id: string; daily_calorie_goal: NullableNumber; daily_protein_goal: NullableNumber; daily_carbs_goal: NullableNumber; daily_fat_goal: NullableNumber; monthly_spending_budget: NullableNumber; timezone: string; created_at: string; updated_at: string };
